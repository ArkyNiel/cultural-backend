...
if($requestMethod == 'POST'){
    ...
    if(empty($inputData)){
        // form submission
        $storeInterpretativeScore = storeInterpretativeScore($_POST);
    }else{
        // json submission
        $storeInterpretativeScore = storeInterpretativeScore($inputData);
    }

    echo $storeInterpretativeScore;  // response
